...
export default function NavOption() {
  ...
  const agentOptions = [
    ...
    { label: "সুপার এজেন্ট লিস্ট", link: "/master-agent" },
    { label: "সাব এডমিন লিস্ট", link: "/master-agent" },
    { label: "সাইট এডমিন লিস্ট" , link: "/master-agent"},
  ];
              ...
              {tab.link ? (
                <a
                  ...
                  className={`cursor-pointer px-8 py-2  font-semibold transition-colors duration-200 ${
                    activeTab === tab.label ? "bg-black text-white" : "hover:border-b-2 border-white hover:text-white"
                  }`}
